...
void checkBatteryLed(ballonConfigurations* configurations){
  ...
  if(configurations->currentBattery > BATTERY_CHECK_STATE_1_ADC_MIN && configurations->currentBattery <= BATTERY_CHECK_STATE_1_ADC_MAX){
    ...
    HAL_GPIO_WritePin(GPIOA,GPIO_PIN_9 | GPIO_PIN_10 | GPIO_PIN_12,GPIO_PIN_SET);										
  }
    ...
    HAL_GPIO_WritePin(GPIOA,GPIO_PIN_9 | GPIO_PIN_12 | GPIO_PIN_11 |,GPIO_PIN_SET);										
  }
    ...
    HAL_GPIO_WritePin(GPIOA,GPIO_PIN_10 | GPIO_PIN_12 | GPIO_PIN_11 |,GPIO_PIN_SET);										
  }
  else{
